          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div cslass="x_title">
                    <h2>Stores <small>Sub-admin</small></h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>2331</td>
                          <td>19</td>
                          <td>dewalt@gmail.com</td>
                          <td>Park Lane</td>
                          <td>London</td>
                          <td><img src="assets/images/paypal.png"></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>Park Lane</td>
                          <td>London</td>
                          <td><img src="assets/images/visa.png"></td>
                          <td>
                            <button class="btn btn-success" data-toggle="modal" data-target="#view"><span class="fa fa-eye"></span></button>
                            <button class="btn btn-danger" data-toggle="modal" data-target="#"><span class="fa fa-trash"></span></button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>Park Lane</td>
                          <td>London</td>
                          <td><img src="assets/images/american-express.png"></td>
                          <td>
                            <button class="btn btn-success" data-toggle="modal" data-target="#view"><span class="fa fa-eye"></span></button>
                            <button class="btn btn-danger" data-toggle="modal" data-target="#"><span class="fa fa-trash"></span></button>
                          </td>
